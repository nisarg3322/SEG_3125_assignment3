...
import {Card, Button, Image, Container, Nav, NavDropdown, Navbar, Row, Col, ToggleButtonGroup, ToggleButton} from "react-bootstrap";
  ...
  return (
   <div className="Home">
      <header className="App-header">
        ...
        <Container>
          <Navbar.Brand style={{ fontFamily: 'Courier new', marginTop: '3px', color: '#D714D7' }} href="">MemMatch</Navbar.Brand> 
        ...
        <Col className='d-flex justify-content-center ' md={12}>
          <Card style={{ width: '500px', backgroundColor: '#000000' }}>
            <Card.Body className='card-border'>
              <Card.Title style={{ color: '#00FFFF', fontSize: '30px' }}>Contact:</Card.Title>
              <Card.Text>
